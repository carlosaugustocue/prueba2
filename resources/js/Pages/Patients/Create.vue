    ...
    <AppLayout>
        <div class="max-w-3xl mx-auto">
            <div class="mb-6">
                ...
                <h1 class="text-2xl font-bold text-gray-900 mt-2">Nuevo Paciente</h1>
            </div>
            ...
            <form @submit.prevent="submit" class="space-y-6">
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                    ...
                    <div class="px-6 py-4 grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input v-model="form.first_name" type="text" :class="['block w-full rounded-lg border-gray-300 shadow-sm focus:border-green-500 focus:ring-green-500', form.errors.first_name ? 'border-red-300' : '']" />
                            <p v-if="form.errors.first_name" class="mt-1 text-sm text-red-600">{{ form.errors.first_name }}</p>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Apellidos *</label>
                            <input v-model="form.last_name" type="text" :class="['block w-full rounded-lg border-gray-300 shadow-sm focus:border-green-500 focus:ring-green-500', form.errors.last_name ? 'border-red-300' : '']" />
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                    ...
                    <div class="px-6 py-4 grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input v-model="form.phone" type="tel" placeholder="3001234567" class="block w-full rounded-lg border-gray-300 shadow-sm focus:border-green-500 focus:ring-green-500" />
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">WhatsApp 📱</label>
                            <input v-model="form.whatsapp" type="tel" placeholder="3001234567" class="block w-full rounded-lg border-gray-300 shadow-sm focus:border-green-500 focus:ring-green-500" />
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">EPS *</label>
                            <select v-model="form.eps_id" :class="['block w-full rounded-lg border-gray-300 shadow-sm focus:border-green-500 focus:ring-green-500', form.errors.eps_id ? 'border-red-300' : '']">
                ...
                <div class="flex justify-end space-x-4">
                    <Link href="/patients" class="inline-flex items-center justify-center px-6 py-3 font-medium rounded-lg bg-white text-gray-700 border border-gray-300 hover:bg-gray-50">
                        Cancelar
                    </Link>
