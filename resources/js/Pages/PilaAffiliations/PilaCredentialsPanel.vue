...
const forms = ref({}); // { [key]: { user, password, noAplica?, operator? } }
...
const dots = (hasPassword) => (hasPassword ? '••••••••' : '—');
...
const cardHasPassword = (key) => Boolean(credentialByKey.value[key]?.hasPassword);
...
const openEditAndMaybeReveal = async (key) => {
    ...
    // Reducimos clics: al abrir la tarjeta configurada intentamos revelar la contraseña
                    ...
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <div class="text-xs text-gray-500 mt-0.5">
                                ...
                                · {{ maskUsername(pilaCredential?.username) }} · {{ dots(pilaCredential?.hasPassword) }}
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <div class="relative mt-1">
                                ...
                                <button
                                    ...
                                    :disabled="revealBusy || !cardHasPassword('pila')"
                    ...
                    <div class="flex items-start justify-between gap-3 p-4">
                        <div class="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <div class="text-xs text-gray-500 mt-0.5">
                                    {{ maskUsername(credentialByKey[c.key]?.username) }} · {{ dots(credentialByKey[c.key]?.hasPassword) }}
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="sm:col-span-2">
                                ...
                                <div class="relative mt-1">
                                    ...
                                    <button
                                        type="button"
                                        class="absolute inset-y-0 right-2 flex items-center"
                                        :disabled="revealBusy || forms[c.key].noAplica || !cardHasPassword(c.key)"
