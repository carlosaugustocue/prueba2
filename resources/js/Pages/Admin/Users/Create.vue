...
import { ArrowLeft, UserPlus, Save, Shield, KeyRound, Phone, Mail, User } from 'lucide-vue-next';
    ...
    <AppLayout>
        <div class="max-w-3xl mx-auto space-y-6">
            ...
            <div>
                ...
                <p class="mt-1 text-sm text-gray-500">Cree un usuario y asigne su rol (permisos)</p>
            </div>
