...
class AffiliateImportServiceTest extends TestCase
{
    ...
    public function test_import_deduplicates_employers_and_encrypts_credentials(): void
    {
        ...
        $tokenPila = Str::random(24);
        $tokenArl = Str::random(24);
        $tokenCcf = Str::random(24);
        $tokenEps = Str::random(24);
        $tokenAfp = Str::random(24);
        ...
        $this->assertSame($tokenPila, Crypt::decryptString($pilaCred->password_encrypted));
        ...
        $this->assertSame($tokenEps, Crypt::decryptString($epsCred->password_encrypted));
    ...
    private function excelRow(
        ...
        // 27 pila user, 28 pila credential value
        // 29 ibc, 30 arl_code, 31 risk_class_level
        // 32 arl user, 33 arl credential value
        // 34 ccf_code, 35 ccf user, 36 ccf credential value
        // 37 eps_code, 38 eps user, 39 eps credential value
        // 40 afp_code, 41 afp user, 42 afp credential value
