...
class UpdateAffiliateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'document_number' => ['required', 'string', 'max:20', Rule::unique('affiliates', 'document_number')->ignore($affiliateId)],
            ...
            'holder_id' => [
                ...
                function ($attribute, $value, $fail) use ($affiliateId) {
                    if ($value == $affiliateId) {
                        $fail('Un afiliado no puede ser su propio cotizante.');
                    }
                },
